...
public protocol ReactionDelegate {
    ...
    func didReact(to message: any Message, reaction: DraftReaction) -> Void
    ...
    func canReact(to message: any Message) -> Bool
    ...
    /// - Note: Called when Chat is preparing to show the Message Menu
    func reactions(for message: any Message) -> [ReactionType]?
    ...
    /// - Note: Optional, defaults to `true`
    /// - Note: Called when Chat is preparing to show the Message Menu
    func allowEmojiSearch(for message: any Message) -> Bool
    ...
    /// - Note: Called when Chat is preparing to show the Message Menu
    func shouldShowOverview(for message: any Message) -> Bool
}

public extension ReactionDelegate {
    func canReact(to message: any Message) -> Bool { true }
    func reactions(for message: any Message) -> [ReactionType]? { nil }
    func allowEmojiSearch(for message: any Message) -> Bool { true }
    func shouldShowOverview(for message: any Message) -> Bool { !message.reactions.isEmpty }
}
...
struct DefaultReactionConfiguration: ReactionDelegate {
    ...
    var didReact: (any Message, DraftReaction) -> Void

    // Optional handlers for further configuration
    var canReact: ((any Message) -> Bool)? = nil
    var reactions: ((any Message) -> [ReactionType]?)? = nil
    var allowEmojiSearch: ((any Message) -> Bool)? = nil
    var shouldShowOverview: ((any Message) -> Bool)? = nil

    init(
        didReact: @escaping (any Message, DraftReaction) -> Void,
        canReact: ((any Message) -> Bool)? = nil,
        reactions: ((any Message) -> [ReactionType]?)? = nil,
        allowEmojiSearch: ((any Message) -> Bool)? = nil,
        shouldShowOverview: ((any Message) -> Bool)? = nil
    ) {
    ...
    func didReact(to message: any Message, reaction: DraftReaction) {
